...
public class mail {
	...
	public static void main(String[] args) throws EmailException, IOException {
      ...
      */
		...
		File screenshot=new File("../maven.selenium.testng/target/surefire-reports/screenshot");
		...
		for(File sf:screen)
		{
			...
			try (FileWriter f = new FileWriter("../maven.selenium.testng/target/surefire-reports/emailable-report.html", true);
